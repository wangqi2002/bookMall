  ...
  <div class="content-page">
    ...
    <div class="content-main">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="拒收" name="fifth"></el-tab-pane>
      </el-tabs>
        ...
        <el-checkbox-group>
          <div v-for="item in tableData" :key="item.index" class="list-wrap clearfix">
            <div class="header clearfix">
              <div class="left">
                <div class="status-text">{{ item.buyerorder_status }}</div>
                <div class="add-time">下单时间：{{ item.buyerorder_time }}</div>
                <div class="order-id">订单号：{{ item.buyerorder_id }}</div>
              </div>
              <div class="right">
                <div class="price-wrap">下单价格{{ item.buyerorder_price }}元</div>
              </div>
            </div>
            <div class="content-wrap clearfix">
              ...
              <div class="main">
                <div class="m1">
                  <div class="user-name">配送人</div>
                  <div class="user-mobile">配送人手机号</div>
                </div>
                <div class="user-address">配送地址</div>
              </div>
            </div>
          </div>
        </el-checkbox-group>
